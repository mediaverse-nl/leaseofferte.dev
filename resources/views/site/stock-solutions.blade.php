        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="padding: 5px 0px !important; margin-bottom: 0px !important;">
                    ...
                    <li class="breadcrumb-item active">  Lease Voorraad </li>
                </ol>
            </nav>
            <div class="row" style="padding: 30px 0px 100px 0px;">
                <div class="col-12">
                    <h1 class="display-4">Lease Voorraad</h1>
                    <br>
                    ...
                    <div id="cover">
                        <div class="td" style="width:90%;">
                            <input type="text" placeholder="ZOEK HIER" class="quicksearch" required>
                        </div>
...
{{--                            @endforeach--}}
            ...
            <div class="col-md-9">
                ...
                <div class="card" style="overflow: hidden; border: none !important; background: #FFFFFF !important; margin-top: -100px !important;">
                    <div class="card-body">
                        <div class="grid">
                            @foreach($stock as $solution)
                                <div class="grid-item category-{!! $solution->id !!}" style="padding: 10px;" >
{{--                                    <a href="{!! route('site.stock.show', [$solution->urlTitle, $solution->id]) !!}">--}}
