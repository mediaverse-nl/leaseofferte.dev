<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            ...
            <img src="/img/leaseofferte-logo.png" alt="leaseofferte.nl" class="img-fluid" style="height: 50px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto main-menu-top">
                ...
                <li class="nav-item {{request()->is('lease-oplossingen*') ? 'active' : ''}}">
                    <a class="nav-link" href="{{ route('site.solution.index') }}">lease categorieën </a>
                </li>
