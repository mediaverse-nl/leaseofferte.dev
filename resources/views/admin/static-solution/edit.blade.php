...
@section('breadcrumb')
    {!! Breadcrumbs::render('admin.static-solution.edit', $solution) !!}
@endsection

@section('content')
    {!! Form::model($solution, ['route' => ['admin.static-solution.update', $solution->id], 'method' => 'PATCH']) !!}
            ...
            <div class="card">
                <div class="card-body">
                    @component('components.model', [
                            'id' => 'CreateCategory',
                            'title' => 'Edit entry ',
                            'actionRoute' => route('admin.static-solution.update', $solution->id),
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="productThumbnail" class="form-control" type="text" disabled
                                   value="{!! $solution->images !!}">
                            {!! Form::hidden('images', $solution->images, ['id' => 'productThumbnailCopy', 'class' => 'form-control'.(!$errors->has('images') ? '': ' is-invalid ')]) !!}
                        </div>

                        @include('components.error', ['field' => 'images'])

                        <div id="imgHolder" style="margin-top:15px;max-height:100px;">
                            @if(!empty($solution->images))
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('looptijd[]', array_combine([12,18,24,30,36,42,48,54,60,72], [12,18,24,30,36,42,48,54,60,72]), explode(',',$solution->looptijd), ['data-max-options="3"', 'id="selectpicker"', 'data-live-search="true"', 'multiple', 'class' => 'form-control'.(!$errors->has('looptijd') ? '': ' is-invalid ')]) !!}
