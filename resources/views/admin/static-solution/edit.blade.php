...
@section('content')
    ...
    @endphp
    {!! Form::model($solution, ['route' => ['admin.static-solution.update', $solution->id], 'method' => 'PATCH', 'autocomplete="off"']) !!}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="pull-right">updated at: {!! $solution->updated_at->format('d-m-Y H:i') !!}</span>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped" id="FinancialDataTable">
                        ...
                        <tbody>
{{--                        {!! dd(request()->old('lease_conditions')) !!}--}}
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped" id="colorDataTable">
                        ...
                        @if(request()->old('kleur'))
                            ...
                            @endforeach
                        @else
                            @foreach(explode(',', $solution->kleur) as $k => $v)
                                <tr>
                                    <td>
                                        <div class="form-group" style="margin-bottom: 0px !important;">
                                            {!! Form::text('kleur[]', $v, ['id="color"', 'placeholder="-- select --"', 'class' => 'color form-control']) !!}
                                        </div>
                                    </td>
                                    <td style="width: 20px;">
                                        <button type="button" class="btn btn-danger btn-sm" id="DeleteButton">
