...
@section('breadcrumb')
    {!! Breadcrumbs::render('admin.static-solution.index') !!}
@endsection
        ...
        @slot('table')
            @foreach($solutions as $solution)
                <tr class="">
                    ...
                    <td>{!! $solution->merk !!}</td>
                    <td>{!! $solution->type !!}</td>
                    <td>{!! $solution->catalogusprijs !!}</td>
                    <td>
                        @component('components.model', [
                               'id' => 'userTableBtn'.$solution->id,
                               'title' => 'Delete entry '.$solution->id,
                               'actionRoute' => route('admin.static-solution.destroy', $solution->id),
                            ...
                            @endslot
                        @endcomponent
                        <a href="{{route('admin.static-solution.edit', $solution->id)}}" class="rounded-circle edit">
